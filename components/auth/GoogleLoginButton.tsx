...
export default function GoogleLoginButton() {
    ...
    return (
        <button
            ...
            className="flex h-10 w-full flex-row items-center justify-center gap-2 rounded-md bg-white text-zinc-900 border border-zinc-200 p-2 text-sm font-semibold hover:bg-zinc-50 dark:bg-zinc-900 dark:text-zinc-100 dark:border-zinc-800 dark:hover:bg-zinc-800"
        >
